    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <header class="topbar" data-navbarbg="skin6">
            <nav class="navbar top-navbar navbar-expand-lg">
                <div class="navbar-header bg-white shadow" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        <!-- Logo icon -->
                        <a href="{{ route('home') }}">
                            <img src="{{ asset('assets/images/logo2.png') }}" width="80" alt="LOGO-PNG"
                                class="img-fluid">
                        </a>
                    </div>
                    <!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            {{-- <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Muy buenos días!</h3>
                    ...
                    <div class="col-5 align-self-center">
                        <div class="customize-input float-end">
                            <select
                                ...
                                <option selected>Aug 24</option>
                                <option value="1">July 24</option>
                                <option value="2">Jun 24</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <footer class="footer text-center text-muted">
                Made with &#128156;  <b>{{date('Y')}}</b> <a
                    href="#">Daniela Mallozi &#128587;</a>.
            </footer>
